...
const turnIcon = document.querySelector<HTMLImageElement>(".header__turn-icon");
...
function turn() {
  cells.forEach((cell) => {
    ...
    cell.addEventListener("click", () => {
      const xIcon: string = "assets/img/icon-x-gray.svg";
      const oIcon: string = "assets/img/icon-o-gray.svg";
